...
2. Establish the current TiProxy state before proposing changes:
- Prefer a local TiProxy checkout if the user provides one.
- Otherwise inspect `https://github.com/pingcap/tiproxy`.
...
- Base the diagram on verified TiProxy components and the proposed data flow or control flow.
